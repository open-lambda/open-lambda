...
from olTornado.concurrent import dummy_executor, run_on_executor
from olTornado.ioloop import IOLoop
from olTornado.util import Configurable, errno_from_exception
...
class Resolver(Configurable):
    ...
    class method::
        ...
        Resolver.configure('olTornado.netutil.ThreadedResolver')

    The implementations of this interface included with Tornado are

    * `olTornado.netutil.DefaultLoopResolver`
    * `olTornado.netutil.DefaultExecutorResolver` (deprecated)
    * `olTornado.netutil.BlockingResolver` (deprecated)
    * `olTornado.netutil.ThreadedResolver` (deprecated)
    * `olTornado.netutil.OverrideResolver`
    * `olTornado.platform.twisted.TwistedResolver` (deprecated)
    * `olTornado.platform.caresresolver.CaresResolver` (deprecated)
...
def ssl_wrap_socket(
    ...
    **kwargs: Any
    ...
    # python3 -m olTornado.httpclient https://sni.velox.ch
