...
via `olTornado.web.RequestHandler.request`.
"""
...
from olTornado.escape import native_str, parse_qs_bytes, utf8
from olTornado.log import gen_log
from olTornado.util import ObjectDict, unicode_type
...
class HTTPServerRequest(object):
    ...
    .. versionchanged:: 4.0
       Moved from ``olTornado.httpserver.HTTPRequest``.
    """
