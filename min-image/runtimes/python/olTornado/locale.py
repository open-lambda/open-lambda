...
To load a locale and generate a translated string::
    ...
    user_locale = olTornado.locale.get("es_LA")
    print(user_locale.translate("Sign out"))

`olTornado.locale.get()` returns the closest matching locale, not necessarily the
...
from olTornado._locale_data import LOCALE_NAMES
