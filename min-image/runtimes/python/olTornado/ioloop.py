...
from olTornado.concurrent import (
    Future,
    is_future,
    chain_future,
    future_set_exc_info,
...
from olTornado.util import Configurable, TimeoutError, import_object
...
class IOLoop(Configurable):
    ...
    .. testcode::
        ...
        import tornado
        from olTornado.iostream import IOStream
        ...
        def connection_ready(sock, fd, events):
            while True:
                ...
                io_loop = olTornado.ioloop.IOLoop.current()
    ...
    `olTornado.process` and `multiprocessing` modules) should do so as early as
    ...
    def configure(
        ...
        from olTornado.platform.asyncio import BaseAsyncIOLoop
    ...
    def current(instance: bool = True) -> Optional["IOLoop"]:  # noqa: F811
        ...
        try:
            ...
            if instance:
                from olTornado.platform.asyncio import AsyncIOMainLoop
    ...
    def configurable_default(cls) -> Type[Configurable]:
        from olTornado.platform.asyncio import AsyncIOLoop
    ...
    def run_sync(self, func: Callable, timeout: Optional[float] = None) -> Any:
        ...
        .. versionchanged:: 6.2
           ``olTornado.util.TimeoutError`` is now an alias to ``asyncio.TimeoutError``.
        """
        ...
        def run() -> None:
            try:
                ...
                if result is not None:
                    from olTornado.gen import convert_yielded
    ...
    def add_future(
        ...
        if isinstance(future, Future):
            ...
            # olTornado.concurrent.future_add_done_callback. We always want
            ...
            # the error logging (i.e. it goes to olTornado.log.app_log
        ...
        *args: Any
        ...
        if executor is None:
            if not hasattr(self, "_executor"):
                from olTornado.process import cpu_count
