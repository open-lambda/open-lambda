...
from olTornado import ioloop
from olTornado.iostream import PipeIOStream
from olTornado.log import gen_log
...
class Subprocess(object):
    ...
    * ``stdin``, ``stdout``, and ``stderr`` may have the value
      ``olTornado.process.Subprocess.STREAM``, which will make the corresponding
