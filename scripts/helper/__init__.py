...
def get_ol_stats():
    ...
    if os.path.exists(f"{_OL_DIR}/worker/stats.yaml"):
        with open(f"{_OL_DIR}/worker/stats.yaml", "r", encoding='utf-8') as statsfile:
            olstats = yaml.load(statsfile)
